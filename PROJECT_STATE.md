...
- `/components`: `Navbar` (Typography Brand + ID/EN Language Switcher), `Footer`, `HeroSection`, `CompanyProfileSection`, `ServicesSection`, `PortfolioSection`, `ContactSection`, `ProjectCard`, `ProjectForm`, `ServiceForm`, `DeleteButton`
